...
namespace Gunsmith.Interaction
{
    ...
    public enum ShopAction
    {
        ...
        /// <summary>
        /// Tips the powder pan back into the tin.
        ///
        /// Necessary the moment charging became a pour: you cannot un-pour a grain, so
        /// without a way to start over an overshoot would strand the player with a charge
        /// they did not want and no route back.
        /// </summary>
        TipThePan = 6
    }
